...
test:
	docker run --rm -it -v $(shell pwd):/go/src/docker-go -w /go/src/docker-go golang:latest go get -u -v github.com/golang/dep/cmd/dep ; go get -v github.com/tebeka/go2xunit; dep ensure -v ; 2>&1 go test -v | go2xunit -output tests.xml
